...
*   **Memory Files Structure:** A system of core and optional files in `docs/` and `tasks/` to maintain project context.
    *   **Core Files (Required):**
        ...
        6.  `.gemini/rules/error-documentation.mdc`: Reusable fixes/corrections, known issues log.
        7.  `.gemini/rules/lessons-learned.mdc`: Learning journal (patterns, preferences, intelligence).
...
*   **Documentation Updates:**
    ...
    *   **Rule Updates:** Keep `.gemini/rules/*` files reviewed and updated.
