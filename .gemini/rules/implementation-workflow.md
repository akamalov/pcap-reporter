...
flowchart TD
    ...
    Update --> Rules[Update [lessons-learned.mdc](mdc:.gemini/rules/lessons-learned.mdc), [error-documentation.mdc](mdc:.gemini/rules/error-documentation.mdc) if needed]
