...
This file provides comprehensive guidance to Gemini CLI when working with code in any repository. These rules are organized by category and should be referenced based on the specific development context.

## 🎯 Core Philosophy & Principles

**Reference**: [core-philosophy.md](.gemini/rules/core-philosophy.md)
...
**Reference**: [communication-rules.md](.gemini/rules/communication-rules.md)
...
**Reference**: [implementation-workflow.md](.gemini/rules/implementation-workflow.md)
...
**Reference**: [architecture-understanding.md](.gemini/rules/architecture-understanding.md)
...
**Reference**: [system-patterns.md](.gemini/rules/system-patterns.md)
...
**Reference**: [code-style-quality.md](.gemini/rules/code-style-quality.md)
...
- Reference Gemini CLI prompts in .gemini/prompts/ directory

## 🧪 Testing & Quality Assurance

**Reference**: [testing.md](.gemini/rules/testing.md)
...
**Reference**: [debugging-workflow.md](.gemini/rules/debugging-workflow.md)
...
**Reference**: [directory-structure.md](.gemini/rules/directory-structure.md)
...
**Reference**: [security.md](.gemini/rules/security.md)
...
**Reference**: [documentation-memory.md](.gemini/rules/documentation-memory.md)
...
**Reference**: [version-control.md](.gemini/rules/version-control.md)
...
**Reference**: [planning-workflow.md](.gemini/rules/planning-workflow.md)
...
**Reference**: [improvements-suggestions.md](.gemini/rules/improvements-suggestions.md)
...
**Reference**: [feature-implementation.md](.gemini/rules/feature-implementation.md)
...
- **[apm_impl_plan_critical_elements_reminder.md](.gemini/rules/apm_impl_plan_critical_elements_reminder.md)**: Implementation plan checklist
- **[apm_memory_system_format_source.md](.gemini/rules/apm_memory_system_format_source.md)**: Memory bank system setup
- **[apm_plan_format_source.md](.gemini/rules/apm_plan_format_source.md)**: Implementation plan formatting
- **[apm_task_prompt_plan_guidance_incorporation_reminder.md](.gemini/rules/apm_task_prompt_plan_guidance_incorporation_reminder.md)**: Task assignment guidance
- **[apm_discovery_synthesis_reminder.md](.gemini/rules/apm_discovery_synthesis_reminder.md)**: Discovery and synthesis procedures
- **[apm_memory_naming_validation_reminder.md](.gemini/rules/apm_memory_naming_validation_reminder.md)**: Memory validation procedures

### SWE-Bench Workflow

**Reference**: [swebench-workflow.md](.gemini/rules/swebench-workflow.md)
...
- Use the pattern `[rule-name.md](.gemini/rules/rule-name.md)` for detailed guidance
- Reference specific sections for targeted guidance
- Combine multiple rules as needed for comprehensive coverage

### Integration with Project Structure

Prompts should be placed under `.gemini/` directory
This CLAUDE.md file should be placed in your project root or `.gemini/` directory structure: 
